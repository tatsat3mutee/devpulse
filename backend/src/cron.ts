...
import { retentionDays, RETENTION_DELETE_SQL } from "./retention.js";
...
async function runRetentionCleanup(): Promise<void> {
  try {
    ...
    console.log(`Retention: removed ${rowCount ?? 0} items older than ${days}d (kept saves, seen items and concept evidence)`);
  } catch (err) {
